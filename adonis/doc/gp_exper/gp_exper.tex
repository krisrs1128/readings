...
\end{minted}
\captionof{An example call for Poisson regression with a smooth influence of the
  site location on abundance. The first two \texttt{ti} terms correspond to
  nonlinear main effects of site location, while the third provides an
  interaction. The corresponding call for gaussian response uses a
